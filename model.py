...
class model: 
    def __init__(self):
        self.db_connection = conexao() #Classe com vinculo á conexão. 
        self.db_connection = self.db_connection.conectar()#Conectando ao banco de dados.
        self.con = self.db_connection.cursor()#Navega no banco.
